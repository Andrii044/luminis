        ...
        {cartOpen && (
          <>
            <motion.div
              ...
              style={{ background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(4px)', WebkitTapHighlightColor: 'transparent' }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6" style={{ WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
                {items.length === 0 ? (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-1" style={{ border: '1px solid rgba(255,255,255,0.07)' }}>
                              <button
                              ...
                              <span className="font-sans text-xs w-6 text-center" style={{ color: 'rgba(240,225,200,0.8)' }}>{item.quantity}</span>
                              <button
                                onClick={() => updateQuantity(item.id, item.quantity + 1)}
                                className="p-3"
                                style={{ color: 'rgba(200,175,140,0.6)', WebkitTapHighlightColor: 'transparent' }}
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                ...
                                className="p-2"
                                style={{ color: 'rgba(160,100,100,0.6)', WebkitTapHighlightColor: 'transparent' }}
                              >
                                <Trash2 size={15} />
                              </button>
                            </div>
              ...
              {items.length > 0 && (
                <div className="px-6 py-5" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <button
                    ...
                    className="w-full font-sans text-[10px] tracking-[0.22em] uppercase py-4"
                    style={{
